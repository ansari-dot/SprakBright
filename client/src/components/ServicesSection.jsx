            ...
            {services.map((service) => (
              <div key={service.id} className="px-2 sm:px-3 md:px-4">
                <div className="group bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 sm:hover:-translate-y-2 h-full mx-auto" style={{ maxWidth: '400px' }}>
                  <div className="p-6 sm:p-7 md:p-8 text-center flex flex-col h-full">
                    {/* Icon */}
                    <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#0098da] transition-colors duration-300">
                      <div className="text-3xl sm:text-4xl text-[#0098da] group-hover:text-white transition-colors duration-300">
                        {service.icon}
                      </div>
                    </div>
